    ...
    if (length && length > 2 && data[0] == '4' && data[1] == '2') {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          /**
           * A path made up of (x,y) points that the car will visit
      ...
      int carLane = -1;
        ...
        // check which lane the neighbouring car is in
        ...
        else
        {
         ...
         // check if the car is close or in right or left 

        switch (  carLane - ego_lane )
        {
          case EGO:
          {
            isInFront |= ((check_car_s > car_s) && ((check_car_s-car_s)<gap));           
            break;
          }
          case LEFT:
          {
            isInLeft |= (((car_s - gap) < check_car_s) && ((car_s + gap) > check_car_s));
            break;
          }
          case RIGHT:
          {
            isInRight |= ((car_s - gap) < check_car_s) && ((car_s + gap) > check_car_s);;
            break;
          }
          default:{}
          //do nothing
        ...
        // if the car is close and neighbouring lanes are free , switch lanes
        // reduce velocity if the car is in front come near 

         if(isInFront)
         {
           if(ego_lane>0 && !isInLeft )
           {
             ego_lane--;
           }
           else if (ego_lane<2 && !isInRight)
           {
             ego_lane++;
           }
           else
         ...
         {
            // increase the velocity if car is not close
            if ( ref_vel < 49.5)
             {
                ref_vel += .224;
             }
